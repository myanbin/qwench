...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>输入图片链接</b></p><p>你也可以为此图片添加一个可选的标题。如：<br />http://www.example.com/images/cloud.jpg   \"title\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>输入网页链接</b></p><p>你也可以为此链接添加一个可选的标题。如：<br />http://www.example.com/   \"title\"</p>";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			linkButton.title = "插入链接 <a> Ctrl+L";
			...
			codeButton.title = "插入代码片段 <pre><code> Ctrl+K";
			...
			imageButton.title = "插入图片 <img> Ctrl+G";
